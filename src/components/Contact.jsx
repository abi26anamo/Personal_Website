...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-10 md:px-40 text-white text-center">
          ...
          <div className="flex flex-col gap-7">
            {contact_info.map((contact, i) => (
              <div key={i} className="flex gap-4 w-fit items-center">
                <div className=" sm:right-8 right-4 z-[999] cursor-pointer text-white md:text-3xl text-xl bg-cyan-600 md:w-12 w-8 md:h-12 h-8 flex items-center justify-center rounded-full">
                  {contact.logo}
                </div>
